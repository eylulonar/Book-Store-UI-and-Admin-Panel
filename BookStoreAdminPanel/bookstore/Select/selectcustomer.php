                    ...
                    <div class="card shadow mt-3">
                        ...
                        <div class="card-body">
                            ...
                            <?php
                                ...
                                $cat_query = "SELECT * FROM customer";
                                ...
                                if(mysqli_num_rows($cat_query_run) > 0)
                                {
                                    foreach($cat_query_run as $catlist)
                                    {
                                        ...
                                        ?>
                                            <div>
                                                <input type="checkbox" name="custs[]" value="<?= $catlist['cid']; ?>" 
                                                    <?php if(in_array($catlist['cid'], $checked)){ echo "checked"; } ?>
                                                 />
                                                <?= $catlist['csname']; ?>
                                            </div>
                                        <?php
                ...
                <div class="card ">
                    <div class="card-body row">
                        <?php
                            ...
                            {
                                $branchecked = [];
                                $branchecked = $_GET['custs'];
                                foreach($branchecked as $rowbrand)
                                {
                                    // echo $rowbrand;
                                    $products = "SELECT * FROM customer WHERE cid IN ($rowbrand)";
